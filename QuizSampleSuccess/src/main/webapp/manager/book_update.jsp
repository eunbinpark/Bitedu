...
<form action="" method="post" id='frm'>
    <table>
        ...
        <tr>
            <td>도서번호</td>
            <td colspan="2">
            	<input type="text" id="book_seq" name="book_seq" value="<%=copy.getBookSeq() %>" readonly>
            </td>
            <td>
            </td>
         </tr>
        <tr>
        	<td>ISBN</td>
        	<td colspan="2">
        		<input type="text" id="isbn" name="isbn" value="<%=copy.getIsbn() %>" readonly>
        	</td>
        ...
        <tr>
        	<td>출판일</td>
        	<td colspan="2">
        		<input type="text" id="publish_date" size="35" name="publish_date" value="<fmt:formatDate value="<%=copy.getPublishDate() %>" pattern="yyyy-MM-dd"/>">
        	</td>
        	<td></td>
        <tr>
        <tr>
