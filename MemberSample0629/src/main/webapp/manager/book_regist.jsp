...
<body>
	...
	<form action="/MemberSample0629/BlmController?cmd=list" method="post"
		id="frm">
		<table>
			<tr>
			...
			<tr>
				<td>도서번호</td>
				<td colspan="2"><input type="text" id="book_seq"
					name="book_seq" disabled="disabled"></td>
			...
			<tr>
				<td>도서명</td>
				<td colspan="2"><input type="text" id="book_title"
					name="book_title"></td>
				<td></td>
			</tr>
			<tr>
			...
			<tr>
				<td>출판사</td>
				<td colspan="2"><input type="text" id="publisher" size="35"
					name="publisher"></td>
				<td></td>
			</tr>
			<tr>
				<td>출판일</td>
				<td colspan="2"><input type="text" id="publish_date" size="35"
					name="publish_date"></td>
				<td></td>
			<tr>
			<tr>
				<td>도서위치</td>
				<td colspan="2"><select name="book_position"
					disabled="disabled">
			...
			<tr>
				<td>도서상태</td>
				<td colspan="2"><select name="book_status" disabled="disabled">
