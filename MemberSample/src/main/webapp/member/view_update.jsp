...
<form action="/MemberSample/memberController" method="get">
    <table>
        ...
        <tr>
            ...
            <td id="message"></td></tr>
        <tr><td>비밀번호</td><td colspan="2"><input type="text" id="pwd1" name="pwd1" value="<%=user.getPwd() %>"></td><td rowspan="2"><input type="hidden" id="flag" value="false"></td></tr>
        ...
        <tr><td>우편번호</td><td colspan="2"><input type="text" id="postal" name="postal" readonly value="<%=user.getZipcode() %>"><button id="find_zipcode">우편번호찾기</button></td><td rowspan="3"></td></tr>
        <tr><td>주소1</td><td colspan="2"><input type="text" id="addr1" size="35" name="addr1" readonly value="<%=user.getAddr1() %>"></td></tr>
        <tr><td>주소2</td><td colspan="2"><input type="text" id="addr2" size="35" name="addr2" readonly value="<%=user.getAddr2() %>"></td><tr>
        <tr>
            <td>생년월일</td>
            <td colspan="2">
            
            	<input type="text" id="" placeholder="년도" size="5" readonly="readonly" value = <%= user.getBirthday()[0] %>>-
                <input type="text" id="" placeholder="월" size="5" readonly value = <%= user.getBirthday()[1] %>>-
                <input type="text" id="" placeholder="일" size="5" readonly value = <%= user.getBirthday()[2] %>>
                <br><br>
